Vonage Video Basic Background Blur with Promises
================================================

This sample application shows how to add background blur with the Vonage
Video APIs. It is very similar to the [Basic Video Chat Promises](../Basic%20Video%20Chat%20Promises/) example, but it adds a background blur to the publisher in browsers that support media processors. 
...
[![Open in StackBlitz](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/fork/github/Vonage/vonage-video-api-web-samples/tree/main/Basic-Background-Blur-Promises)
