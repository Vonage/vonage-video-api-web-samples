...
[![Open in StackBlitz](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/fork/github/Vonage/vonage-video-api-web-samples/tree/main/Client-Observability)
...
Sender-side statistics are included as an optional `senderStats` object inside the `stats` object resolved by `Subscriber.getStats()` method. The `senderStats` object contains two properties:
